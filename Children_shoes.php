...
<html lang="en">
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    $('#myBtn').click(function(){
      ...
      var val = document.getElementById("row_no").value;
         ...
         url: 'Load_more_children_shoes.php',
         data: {
  ...
  <h3 id="fashion_type">CHILDREN SHOES AND SHORTS</h3>
   <hr>
...
<br></br>
  ...
  <?php
   ...
   $sql1="SELECT id, left(subject,50) as subject, image, category FROM tbl_articles where category='Accessories' ORDER BY RAND() LIMIT 20";
   ...
   while($row1=mysql_fetch_assoc($result1))
   {
      ...
      <a href="Published_article.php?sno=<?php echo $row1['id'];?>"> <img src="<?php echo $path2; ?>" alt="image" width="250px" height="260px"></a>
