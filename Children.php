...
<html lang="en">
  ...
  <h3 id="fashion_type">CHILDREN SHIRTS</h3>
   <hr>
  ...
  <div id="hot_block">
   <h4>TRENDING FASHION WEARS FOR FASHIONATE CHILDREN</h4>
   </div>
...
<br></br>
  ...
  <?php
   ...
   $sql1="SELECT id, left(subject,50) as subject, image, category FROM tbl_articles where category='Children Shoes' or category='Children Shirts' or category='Children Jackets' ORDER BY RAND() LIMIT 20";
