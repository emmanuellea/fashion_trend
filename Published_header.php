...
<html lang="en">
  <head>
    ...
    <link href="Mycss/Additionalcss.css" rel="stylesheet">
    ...
    <script src="Myjs/Affixed.js"></script>
...
<br></br>
  ...
  <?php
   ...
   $sql4="select * from tbl_header_image where id='".$sno."'";
   ...
   {
	   $path2="Header_image/".$row4['image'];
	   ?>
           
       <div id="published_title">
       <p style="font-size:35px !important; font-weight:bold; line-height:40px;"><?php echo $row4['title']?>.</p>
    ...
    <br>
    <img src="<?php echo $path2; ?>" alt="image" width="100%" height="350px" id="myImg"/>
...
<br></br>
  ...
  <?php
   ...
   <textarea rows="3" name="comment" id="comment" class="form-control" placeholder="Write your comment here" maxlength="300"></textarea>
    </div>
    <input type="text" name="name" id="name" placeholder="Type your name" class="form-control name" maxlength="70">
   <br>
   
   <input type="submit" name="submit" id="submit" class="btn btn-primary pull-right submit" value="Post your comment">
 ...
 $sql6="select * from tbl_comments order by id desc";
 ...
 while($row6=mysql_fetch_assoc($result6)){
  ...
  <div class="media-left">
    <img src="Header_image/Togikwatako.jpg" class="media-object" style="width:80px; width:60px; border-radius:50%;">
  </div>
  <div class="media-body">
    <h4 class="media-heading"><?php echo $row6['name']?>;  Posted:<?php echo $row6['date']?></h4>
