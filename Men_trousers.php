...
<html lang="en">
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    $('#myBtn').click(function(){
      ...
      var val = document.getElementById("row_no").value;
         ...
         url: 'Load_more_men_trousers.php',
         data: {
  ...
  <h3 id="fashion_type">MEN TROUSERS</h3>
   <hr>
  ...
  <div id="hot_block">
   <h4>TRENDING FASHION WEARS FOR FASHIONATE MEN</h4>
   </div>
...
<br></br>
  ...
  <?php
   ...
   $sql1="SELECT id, left(subject,50) as subject, image, category FROM tbl_articles where category='Men shirts' or category='Accessories' or category='Men Bags' or category='Men Shoes' or category='Men Jackets' ORDER BY RAND() LIMIT 20";
   ...
   while($row1=mysql_fetch_assoc($result1))
   {
      ...
      <a href="Published_article.php?sno=<?php echo $row1['id'];?>"> <img src="<?php echo $path2; ?>" alt="image" width="250px" height="300px"></a>
