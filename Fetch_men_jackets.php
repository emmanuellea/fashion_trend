<?php
 ...
 require 'DbConnection.php';
   ...
   $sql1="select id, left(subject, 50) as subject, image, date, Left(description, 80) as description, category from tbl_articles where category='Men Jackets' ORDER BY id desc LIMIT 0,20";
