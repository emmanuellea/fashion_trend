...
<html lang="en">
  ...
  <h3 id="fashion_type">ACCESSORIES AND JEWELLERY</h3>
   <hr>
   <br></br>
 ...
 <br></br>
  ...
  <div class="row">
   ...
   <div id="hot_block">
   <h4>TRENDING FASHION JEWELLERY FOR FASHIONATE WOMEN</h4>
   </div>
...
<br></br>
  ...
  <br></br>
  <button type="button" class="btn btn-primary" id="loadmore">Show more Jewellery</button>
  </div>
