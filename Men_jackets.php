...
<html lang="en">
  ...
  <h3 id="fashion_type">MEN JACKETS</h3>
   <hr>
...
<br></br>
  ...
  <?php
   ...
   $sql1="SELECT id, left(subject,50) as subject, image, category FROM tbl_articles where category='Men Trousers' or category='Men Shirts' or category='Men Bags' or category='Men Shoes' or category='Accessories' ORDER BY RAND() LIMIT 20";
