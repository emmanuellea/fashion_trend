...
<html lang="en">
  ...
  fjs.parentNode.insertBefore(js, fjs);
		 ...
		 fetchall();
			...
			function fetchall()
			{
				$.ajax({
					...
					type:'POST',
					url:'Fetch_children_jackets.php',
    ...
    $('#myBtn').click(function(){
      ...
      var val = document.getElementById("row_no").value;
         ...
         url: 'Load_more_children_jackets.php',
         data: {
  ...
  <h3 id="fashion_type">CHILDREN JACKETS</h3>
   <hr>
...
<br></br>
  ...
  <?php
   ...
   $sql1="SELECT id, left(subject,50) as subject, image, category FROM tbl_articles where category='Children Shirts' or category='Accessories' ORDER BY RAND() LIMIT 20";
