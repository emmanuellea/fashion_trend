...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="Images/broswer.png" type="image/x-icon">
...
<br></br>
  ...
  <div class="container">
   <div class="row">
   <div class="col-md-offset-2 col-md-8" style="background-color:white; padding:20px !important;">
   <h3>About us</h3>
   <hr>
   
   <br>
   <h4 style="text-decoration:underline">About FashionVilla</h4>
   <p>FashionVilla.com covers all major technology inventions plus the business side of technogical industry with indepth analysis, statistics, numbers and facts/figures. Its a new site but the team behind FashionVilla has 2 years of experience in technology blogging. Currently we have a few writers working on the site who cover different technology stories but very soon in future we are planning to start a “Writers Contribution Program” where we will hire new authors on voluntarily or paid basis depending on the experience.</p>
   
   <br>
   
   <h4 style="text-decoration:underline">CURRENT AUTHORS AT Fashionvilla.com</h4>
   <p>We have 5 dedicated authors who contribute in different categories, plus an editor/mod who is responsible for quality check and placements of editorials on the site. Fashionvilla is expanding everyday and we are looking for new ideas to engage the traffic in more suitable ways.</p>
